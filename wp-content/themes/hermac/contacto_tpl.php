...
<div id="site" class="clearfix wrapper">
    ...
    <div id="main" class="grid-center main sections contacto">
        <div id="home" class="col-12 grid-center home">
            <?php if ($contacto->have_posts()):
            while ($contacto->have_posts()):
            $contacto->the_post(); ?>
            <figure class="icon-section col-12 grid-center">
                <img src="<?php echo get_template_directory_uri(); ?>/images/contacto-icon-section.png"/>
            </figure>
